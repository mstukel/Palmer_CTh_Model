...
load('POC model Second Order Outputs.mat')
...
% [norm_misfit0] = POCmodelSecondOrder(k_sorp,k_desorp,starttimes,endtimes,0);
% 
...
for i=1:numiter
    ...
    [proposal_norm_misfit] = POCmodelSecondOrder(proposal_k_sorp,proposal_k_desorp,starttimes,endtimes,0);
    ...
    if mod(i,1000)==0
        origin = 'RunPOCmodelSecondOrder.m'
        save('POC model Second Order Outputs.mat','origin','k_sorp_track','k_desorp_track','loglike_track','prior_track',...
