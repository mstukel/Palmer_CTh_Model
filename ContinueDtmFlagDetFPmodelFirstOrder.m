...
load('Dtm-Flag-Det-FP model First Order Outputs.mat')

% k_sorp_dtm = 0.7/365;                 %Lerner
% k_sorp_flag = 0.7/365;                 %Lerner
% k_sorp_det = 0.7/365;                 %Lerner
% k_desorp = 2/365;                 %Lerner
% Eg_Th = 0.5;
starttimes = [9.5,50];
endtimes = [40,137];
% jmp_k_sorp_dtm = k_sorp_dtm;
% jmp_k_sorp_flag = k_sorp_flag;
...
% [norm_misfit0] = DtmFlagDetFPmodelFirstOrder(k_sorp_dtm,k_sorp_flag,k_sorp_det,k_desorp,Eg_Th,starttimes,endtimes,0);
% 
...
for i=1:numiter
    ...
    [proposal_norm_misfit] = DtmFlagDetFPmodelFirstOrder(proposal_k_sorp_dtm,proposal_k_sorp_flag,proposal_k_sorp_det,proposal_k_desorp,proposal_Eg_Th,starttimes,endtimes,0);
    ...
    if mod(i,100)==0
        origin = 'RunDtmFlagDetFPmodelFirstOrder.m'
        save('Dtm-Flag-Det-FP model First Order Outputs.mat','origin','k_sorp_dtm_track','k_sorp_flag_track','k_sorp_det_track','k_desorp_track','Eg_Th_track','loglike_track','prior_track',...
