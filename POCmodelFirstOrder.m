function [norm_misfit] = POCmodelFirstOrder(k_sorp,k_desorp,starttimes,endtimes,toplot)
...
load('POC model inputs 1.mat')
load('POC model inputs 2.mat')
...
for i=find(time==starttimes(1)):find(time==endtimes(1))
    ...
    %Primary Production and Remineralization
...
if toplot==1
    ...
    plot(time,POCSink_track./ThSink_track,'-b','Color',[0 0.5 1],'LineWidth',2)
    hold on
...
norm_misfit = [norm_misfit_CTh;norm_misfit_SedTrap];
