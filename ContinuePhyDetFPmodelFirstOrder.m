...
load('Phy-Det-FP model First Order Outputs.mat')
...
starttimes = [9.5,50];
endtimes = [40,137];
% jmp_k_sorp_phy = k_sorp_phy;
% jmp_k_sorp_det = k_sorp_det/3;
% jmp_k_desorp = k_desorp;
% jmp_Eg_Th = 0.003;
numiter=100*10^3;
...
% [norm_misfit0] = PhyDetFPmodelFirstOrder(k_sorp_phy,k_sorp_det,k_desorp,Eg_Th,starttimes,endtimes,0);
% 
...
for i=1:numiter
    ...
    [proposal_norm_misfit] = PhyDetFPmodelFirstOrder(proposal_k_sorp_phy,proposal_k_sorp_det,proposal_k_desorp,proposal_Eg_Th,starttimes,endtimes,0);
    ...
    if mod(i,1000)==0
        origin = 'RunPhyDetFPmodelFirstOrder.m'
        save('Phy-Det-FP model First Order Outputs.mat','origin','k_sorp_phy_track','k_sorp_det_track','k_desorp_track','Eg_Th_track','loglike_track','prior_track',...
