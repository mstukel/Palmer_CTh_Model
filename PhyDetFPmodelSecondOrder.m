function [norm_misfit] = PhyDetFPmodelSecondOrder(k_sorp_phy,k_sorp_det,k_desorp,Eg_Th,starttimes,endtimes,toplot)
...
for i=find(time==starttimes(1)):find(time==endtimes(1))
    ...
    %Sorption
    PhyTh = PhyTh + k_sorp_phy*Phy.*dTh*dt;
    dTh = dTh - k_sorp_phy*Phy.*dTh*dt;
