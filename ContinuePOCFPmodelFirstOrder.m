...
load('POC-FP model First Order Outputs.mat')
...
% [norm_misfit0] = POCFPmodelFirstOrder(k_sorp,k_desorp,Eg_Th,starttimes,endtimes,0);
% 
...
for i=1:numiter
    ...
    [proposal_norm_misfit] = POCFPmodelFirstOrder(proposal_k_sorp,proposal_k_desorp,proposal_Eg_Th,starttimes,endtimes,0);
