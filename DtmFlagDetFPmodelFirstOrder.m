function [norm_misfit] = DtmFlagDetFPmodelFirstOrder(k_sorp_dtm,k_sorp_flag,k_sorp_det,k_desorp,Eg_Th,starttimes,endtimes,toplot)
...
for i=find(time==starttimes(1)):find(time==endtimes(1))
    ...
    %Sorption
    DtmTh = DtmTh + k_sorp_dtm*dTh*dt;
    dTh = dTh - k_sorp_dtm*dTh*dt;
    FlagTh = FlagTh + k_sorp_flag*dTh*dt;
    dTh = dTh - k_sorp_flag*dTh*dt;
